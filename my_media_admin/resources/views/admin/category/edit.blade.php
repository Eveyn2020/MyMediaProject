        ...
        <div class="card-body">
          <form action="{{route('admin#updateCategory',$data['category_id'])}}" method="post">
            ...
            <div class="form-grup">
                ...
                <input type="text" name="categoryName" value="{{old('categoryName',$data['title'])}}" class="form-control" placeholder="Enter Category Name..">
                @error('categoryName')
            ...
            <div class="form-group">
               ...
               <textarea class="form-control"  name="categoryDescription" cols="30" rows="7" placeholder="Enter Description..">{{old('categoryDescription',$data['description'])}}</textarea>
